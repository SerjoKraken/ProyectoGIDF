...
public class Flujo extends Figura{
    ...
    public void calcularVertices(ArrayList<Figura> figuras){
        ...
        else if(figuras.get(indexHijo).getEstado()==true && figuras.get(indexPadre).getEstado()==true && (figuras.get(indexHijo) instanceof Flujo) && !(figuras.get(indexPadre) instanceof Flujo) &&
                figuras.get(indexHijo).cicloPadre != null){
            v = padre.verticeCentro;
            v2 = hijo.verticeCentro;
            vertices.set(0, v);
            vertices.set(1, v2);
    ...
    public void dibujar(GraphicsContext gc) {
        ...
        if (vertices.size()>2) {
            ...
            }else if (esVerdadero && cicloPadre != null && padre instanceof Ciclo) {
